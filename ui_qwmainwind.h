...
public:
    ...
    void setupUi(QMainWindow *QWMainWind)
    {
        ...
        QIcon icon11;
        icon11.addFile(QString::fromUtf8(":/images/images/my.bmp"), QSize(), QIcon::Normal, QIcon::Off);
        actabout->setIcon(icon11);
    ...
    void retranslateUi(QMainWindow *QWMainWind)
    {
        ...
        menu_4->setTitle(QCoreApplication::translate("QWMainWind", "\345\267\245\345\205\267", nullptr));
    } // retranslateUi
